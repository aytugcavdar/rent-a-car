      ...
      <Container>
        <div className="py-12">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div className="col-span-1 md:col-span-2">
              <Link to="/" className="flex items-center space-x-2 mb-4">
                ...
                <span className="text-xl font-bold text-white">Rent-a-Car</span>
              </Link>
              <p className="text-sm leading-relaxed">
                Türkiye'nin en güvenilir araç kiralama platformu. 
                Binlerce araç seçeneği ile hayalinizdeki yolculuğa çıkın.
              </p>
          ...
          <div className="border-t border-gray-800 mt-8 pt-8 text-sm text-center">
            <p>© {currentYear} Rent-a-Car. Tüm hakları saklıdır.</p>
