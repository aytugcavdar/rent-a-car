  ...
  try {
    ...
    channel.consume(QUEUE_NAME, async (msg) => {
      if (msg !== null) {
        ...
        logger.info(`[✔] Received new booking notification request: Booking ID ${bookingDetails.bookingId}`);
        ...
        try {
          ...
          logger.error(`Failed to send email for booking ${bookingDetails.bookingId}:`, error);
        }
